...
def step2(config_data: dict, routers: list, verbose: bool = False):
    """Step 2: Assign IPv6 /126 networks to interfaces that don't have addresses configured."""
    if verbose:
        print("#STEP 2:")
...
def main():
    ...
    routers = step1(data, verbose=True)

    # Run step2
    step2(data, routers, verbose=True)
    return routers
